...
CREATE INDEX PROP_VALUES_I01
  ON PROP_VALUES(DEVICE_SYSNAME, PROP_CATEGORY, PROP_NAME);

CREATE INDEX PROP_VALUES_I02
  ON PROP_VALUES(PROP_CATEGORY, AID_NAME, PROP_NAME, PROP_VALUE);

CREATE INDEX PROP_VALUES_I03
  ON PROP_VALUES(PROP_CATEGORY, PROP_NAME, PROP_VALUE);
